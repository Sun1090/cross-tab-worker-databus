...
- **Risk / rollback:** three JSDoc/`//` blocks and one `AGENTS.md` sentence. Zero behavior change, so the public-surface gates see nothing and `git revert` removes the phase.
