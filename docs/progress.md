...
## Phase 130 / 0.21.12 prepared — the README was the last un-audited shipped prose

- **Milestone / version:** 0.21.12 (patch; shipped documentation only — no `src/` or `tests/` file touched).
- **Status:** prepared on branch `docs/readme-and-checklist-claims`, three fix commits plus the freeze; tag and publish follow merge.
