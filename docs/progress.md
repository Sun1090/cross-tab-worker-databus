...
- **Verification:** `pnpm typecheck` 0, `pnpm lint` 0, `pnpm build` 0, `pnpm test:coverage` 0 — 37 files / **909** tests at **99.02 / 96.93 / 99.27 / 99.69** against the 98/96/98/99 floors (`cluster.ts` at 99.14 / 94.73 / 100 / 100), `pnpm test:e2e` **37 passed (45.7 s)** — including the BFCache round trip and both pagehide-handoff specs, which is this code's neighborhood — and the documentation gate 18 passed.
