...
- This is the leading candidate for the residue the 0.21.15 entry closed on ("what the experiment did open, and did not answer": six seeds that end with a held transport subscription under asynchronous channel delivery). It is recorded as a candidate, not as verified: raising the hub's delivery fidelity is still its own change.
