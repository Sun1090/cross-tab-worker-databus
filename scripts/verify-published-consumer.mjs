...
const requestedVersion = process.env.PUBLISHED_VERSION || execFileSync('npm', ['view', packageName, 'version', '--registry', 'https://registry.npmjs.org'], { encoding: 'utf8' }).trim();
const version = requestedVersion.replace(/^v(?=\d)/i, '');
